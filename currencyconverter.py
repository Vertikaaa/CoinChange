# Pyhton Project on Currency Converter
...
class RealTimeCurrencyConverter():
    ...
    def convert(self, from_currency, to_currency, amount):
        ...
        amount - round(amount * self.currencies[to_currency], 4)         #upto 4 decimal places
        return amount 
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        #label
        self.intro_label = Label(self,text = 'Welcome to the Currency Converter', fg = 'blue', relief = tk.RAISED,  borderwidth = 3)
        self.intro_label.config(font = ('Courier',15,'bold'))
        
        #Groove style for button
    ...
    def restrictNumberOnly(self, action, string):
        ...
        # re.compile() method is used to compile a regular expression pattern
